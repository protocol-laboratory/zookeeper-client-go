...
func TestEncodeGetDataResp(t *testing.T) {
	...
	bytes := resp.Bytes()
	assert.Equal(t, hex2Bytes(t, "0000000300000000000000320000000000000005776f726c640000000000000031000000000000003200000182ef427d6100000182ef427d65000000010000000000000000000000000000000000000005000000000000000000000031"), bytes)
}
