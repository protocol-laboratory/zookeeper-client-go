...
func TestDecodeStat(t *testing.T) {
	bytes := hex2Bytes(t, "0000000000000005000000000000000600000182ec1b539f00000182ec1b53ac000000010000000000000000000000000000000000000005000000000000000000000005")
...
func TestEncodeStat(t *testing.T) {
	...
	bytes := resp.Bytes()
	assert.Equal(t, hex2Bytes(t, "0000000000000005000000000000000600000182ec1b539f00000182ec1b53ac000000010000000000000000000000000000000000000005000000000000000000000005"), bytes)
}
